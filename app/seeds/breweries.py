...
def seed_breweries():
    lagunitas = Brewery(
        ...
        image_url='https://on-tap-bucket.s3.us-west-1.amazonaws.com/OnTap+Images/brewery-logos/lagunitas_logo.png',
    ...
    four_o_five = Brewery(
        ...
        image_url='https://on-tap-bucket.s3.us-west-1.amazonaws.com/OnTap+Images/brewery-logos/405-brewing-logo.jpg',
    ...
    madtree = Brewery(
        ...
        image_url='https://on-tap-bucket.s3.us-west-1.amazonaws.com/OnTap+Images/brewery-logos/madtree_logo.jpeg',
    ...
    elysian = Brewery(
        ...
        image_url='https://on-tap-bucket.s3.us-west-1.amazonaws.com/OnTap+Images/brewery-logos/Elysian-logo.jpg',
    ...
    stone = Brewery(
        ...
        image_url='https://on-tap-bucket.s3.us-west-1.amazonaws.com/OnTap+Images/brewery-logos/stone_logo.jpeg',
